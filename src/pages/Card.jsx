...
const randomColor = hoverShadowColors[Math.floor(Math.random() * hoverShadowColors.length)];
 
  return (
   <div className="md:w-1/3 w-1/2">
     <div className="group  md:px-5 py-5">
      <div className={`mx-1 my-5 group rounded-lg  shadow-lg hover:scale-110 duration-500  p-2   flex flex-col items-center ${randomColor}`}>
